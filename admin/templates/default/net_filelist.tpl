...
<tr class="normal">
  <td><img src="templates/{$template}/img/fm/{$file_list[db].file_icon}" width="20" height="20" border="0" style="cursor:pointer;" onClick="javascript:filesLoadNet('{$srvid}','{$file_list[db].file_enc_name}','0');" /></td>
